 ...
 *   - 'sdk:*' - Values related to the SDK itself.
 *     - 'sdk:resp:*' - Values related to the SDK responsibilities. Ex: 'sdk:resp:user:session' - Set if the sdk will be responsible for creating the user session.
